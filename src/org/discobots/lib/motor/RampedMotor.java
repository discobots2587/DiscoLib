package org.discobots.lib.motor;
...
public class RampedMotor implements SpeedController {
	 ...
	 * 
	 * @param m
	 *            Any motor (e.g. Spark, Talon, etc.) that inherits
	 *            PWMSpeedController
	 * @param rb
	 *            Rampband constant
	 */
	...
	public void set(double input) {
		...
		// if the change is larger than rampBand (also if the robot is speeding up and
		// not slowing down)
